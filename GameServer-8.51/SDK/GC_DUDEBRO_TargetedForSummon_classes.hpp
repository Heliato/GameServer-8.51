...
public:
	void ExecuteUbergraph_GC_DUDEBRO_TargetedForSummon(int32 EntryPoint, class AActor* K2Node_Event_MyTarget, EGameplayCueEvent K2Node_Event_EventType, struct FGameplayCueParameters& K2Node_Event_Parameters);
