...
public:
	...
	UMulticastInlineDelegateProperty_             MenuScreenDispatcher;                              // 0x0750(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_3AC4[0x4];                                     // 0x078C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
