...
bool ABGA_IslandPortal_C::BlueprintCanInteract(class AFortPawn* InteractingPawn, bool CallFunc_IsPortalInteractable_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1) const
{
	static class UFunction* Func = nullptr;
...
class FText ABGA_IslandPortal_C::BlueprintGetInteractionString(class AFortPawn* InteractingPawn, bool Temp_bool_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable_1, class FText K2Node_Select_Default) const
{
	static class UFunction* Func = nullptr;
