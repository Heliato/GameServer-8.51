...
void UAffiliateKeyModal_C::OnNavUpToAffiliateKey(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue)
{
	...
	Params::AffiliateKeyModal_C_OnNavUpToAffiliateKey Parms{};
...
void UAffiliateKeyModal_C::OnNavDownFromAffiliateKey(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue)
{
	...
	Params::AffiliateKeyModal_C_OnNavDownFromAffiliateKey Parms{};
...
// TDelegate<void(bool bSuccess)>          K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
// bool                                    Temp_bool_Variable_1                                   (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(bool bSuccess, bool bWasValidAffiliateName, const class FString& AffilateNameChecked)>K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
// ESlateVisibility                        K2Node_Select_Default_1                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
