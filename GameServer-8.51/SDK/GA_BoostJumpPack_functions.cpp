...
void UGA_BoostJumpPack_C::ExecuteUbergraph_GA_BoostJumpPack(int32 EntryPoint, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, struct FHitResult& K2Node_CustomEvent_Hit, struct FGameplayEventData& K2Node_Event_EventData, EJumpBoostPackState K2Node_Event_InPreviousState, EJumpBoostPackState K2Node_Event_InCurrentState, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
...
void UGA_BoostJumpPack_C::TransitionFromBoost(Enum_BoostJumpStates* TargetBoostState, bool CallFunc_Not_PreBool_ReturnValue, float CallFunc_GetFuel_Fuel, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
...
void UGA_BoostJumpPack_C::Setup_PlayerPawn(TDelegate<void(struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
	...
	Params::GA_BoostJumpPack_C_Setup_PlayerPawn Parms{};
