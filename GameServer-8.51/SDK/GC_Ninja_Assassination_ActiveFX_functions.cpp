...
void AGC_Ninja_Assassination_ActiveFX_C::ExecuteUbergraph_GC_Ninja_Assassination_ActiveFX(int32 EntryPoint, class AActor* K2Node_Event_MyTarget, EGameplayCueEvent K2Node_Event_EventType, struct FGameplayCueParameters& K2Node_Event_Parameters)
{
...
void AGC_Ninja_Assassination_ActiveFX_C::K2_HandleGameplayCue(class AActor* Param_MyTarget, EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
...
bool AGC_Ninja_Assassination_ActiveFX_C::WhileActive(class AActor* Param_MyTarget, struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
