...
public:
	...
	uint8                                         Pad_4499[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetParams(float Param_ReadyUpTimerLength, TArray<struct FTransform>& Param_InteractSpawnLocation, class FText Param_InteractText, int32 Param_BluGloMissionActivationQty, bool Param_IsFightTheStorm, class UGen_ReadyUp_StartObjective_C** ThisObject);
