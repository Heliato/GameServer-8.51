...
{
public:
	UMulticastInlineDelegateProperty_             OnEulaResponse;                                    // 0x0360(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
