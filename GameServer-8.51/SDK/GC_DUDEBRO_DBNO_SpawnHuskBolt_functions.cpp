...
void UGC_DUDEBRO_DBNO_SpawnHuskBolt_C::K2_HandleGameplayCue(class AActor* MyTarget, EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters) const
{
