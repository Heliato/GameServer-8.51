...
// TDelegate<void(class AFortPlayerController* Controller, class UFortQuestItemDefinition* QuestDef, class FName BackendName, int32 CompletionCount, bool ObjectiveCompleted, bool QuestCompleted)>K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
...
void AB_BGA_Athena_EnvCampFire_C::BlueprintOnInteract(class AFortPawn* Param_InteractingPawn)
{
	static class UFunction* Func = nullptr;
...
class FText AB_BGA_Athena_EnvCampFire_C::BlueprintGetInteractionString(class AFortPawn* Param_InteractingPawn) const
{
	static class UFunction* Func = nullptr;
