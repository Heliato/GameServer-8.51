...
public:
	...
	uint8                                         Pad_2A77[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A78[0x3];                                     // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A79[0x1];                                     // 0x0079(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A7A[0x29B];                                   // 0x007D(0x029B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A7B[0x4];                                     // 0x031C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A7C[0x2F0];                                   // 0x0328(0x02F0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A7D[0x37];                                    // 0x0619(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2A7E[0x34];                                    // 0x0028(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A7F[0x28];                                    // 0x0060(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
