...
void UItemInfoHeaderWidget_C::SetScrollWidget(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	...
	Params::ItemInfoHeaderWidget_C_SetScrollWidget Parms{};
...
void UItemInfoHeaderWidget_C::Update(class UFortItemDefinition* Param_ItemDefinition, int32 Quantity, ESlateVisibility Temp_byte_Variable, class FText CallFunc_GetRichDescription_ReturnValue, class FText CallFunc_GetShortDescription_ReturnValue, const struct FFortColorPalette& CallFunc_GetRarityOrSeriesColors_ReturnValue, bool CallFunc_TextIsEmpty_ReturnValue, ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
