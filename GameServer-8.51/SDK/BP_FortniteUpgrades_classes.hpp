...
public:
	...
	uint8                                         Pad_3FF1[0x6];                                     // 0x0292(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ExecuteUbergraph_BP_FortniteUpgrades(int32 EntryPoint, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, int32 CallFunc_GetShadowQuality_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue, bool CallFunc_BooleanOR_ReturnValue);
