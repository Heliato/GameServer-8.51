...
bool UGCN_SpookyMist_Dive_C::OnActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters) const
{
...
void UGCN_SpookyMist_Dive_C::OnStartParticleSystemSpawned(class UParticleSystemComponent* SpawnedParticleSysComponent, struct FGameplayCueParameters& Parameters, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue) const
{
	static class UFunction* Func = nullptr;
