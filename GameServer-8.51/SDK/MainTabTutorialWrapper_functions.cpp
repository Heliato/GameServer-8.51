...
void UMainTabTutorialWrapper_C::HandleTutorialCallout(class FName& TutorialObjectiveName, ETutorialType TutorialType, const struct FFortUITutorialData& TutorialData, class UFortTutorialContext* CallFunc_GetContext_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_GetSelected_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct FFortUITutorialData& CallFunc_GetTutorialData_OutTutorialData, bool CallFunc_GetTutorialData_ReturnValue, bool CallFunc_HasValidData_Result, const struct FFortToastDisplayInfo& CallFunc_GetTutorialCalloutData_FortToastDisplayInfo)
{
	...
	Parms.CallFunc_GetTutorialData_OutTutorialData = std::move(CallFunc_GetTutorialData_OutTutorialData);
	...
	Parms.CallFunc_GetTutorialCalloutData_FortToastDisplayInfo = std::move(CallFunc_GetTutorialCalloutData_FortToastDisplayInfo);
...
void UMainTabTutorialWrapper_C::CheckFinishTutorialWrapper(class UFortTutorialContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsTutorialCalloutVisible_ReturnValue)
{
	...
	Params::MainTabTutorialWrapper_C_CheckFinishTutorialWrapper Parms{};
...
void UMainTabTutorialWrapper_C::ExecuteUbergraph_MainTabTutorialWrapper(int32 EntryPoint, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class FName K2Node_Event_TutorialObjectiveName, ETutorialType K2Node_Event_TutorialType)
{
	static class UFunction* Func = nullptr;
