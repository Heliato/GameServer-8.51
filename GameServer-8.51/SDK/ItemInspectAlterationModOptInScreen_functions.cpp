...
void UItemInspectAlterationModOptInScreen_C::SetScrollWidget(class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
	...
	Params::ItemInspectAlterationModOptInScreen_C_SetScrollWidget Parms{};
...
void UItemInspectAlterationModOptInScreen_C::BindDelegates(TDelegate<void(class UCommonButton* Button)> K2Node_CreateDelegate_OutputDelegate, TDelegate<void(class UCommonButton* Button)> K2Node_CreateDelegate_OutputDelegate_1, TDelegate<void(class UCommonButton* Button)> K2Node_CreateDelegate_OutputDelegate_2, TDelegate<void(class UCommonButton* Button)> K2Node_CreateDelegate_OutputDelegate_3, TDelegate<void(class UCommonButton* Button)> K2Node_CreateDelegate_OutputDelegate_4)
{
	static class UFunction* Func = nullptr;
	...
	Params::ItemInspectAlterationModOptInScreen_C_BindDelegates Parms{};
...
void UItemInspectAlterationModOptInScreen_C::Reset_To_Show_Help(float CallFunc_GetEndTime_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationTimeRange_ReturnValue)
{
	...
	Params::ItemInspectAlterationModOptInScreen_C_Reset_To_Show_Help Parms{};
...
void UItemInspectAlterationModOptInScreen_C::Update_Colors(EFortRarity CallFunc_GetRarity_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct FFortRarityItemData& CallFunc_BPGetRarityData_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ItemInspectAlterationModOptInScreen_C_Update_Colors Parms{};
