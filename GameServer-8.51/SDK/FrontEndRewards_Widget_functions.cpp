...
void UFrontEndRewards_Widget_C::Play_Victory_Music(TArray<class AFort_Entry_Music_Controller_BP_C*>& CallFunc_GetAllActorsOfClass_OutActors, class AFort_Entry_Music_Controller_BP_C* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::FrontEndRewards_Widget_C_Play_Victory_Music Parms{};
...
void UFrontEndRewards_Widget_C::PopulateItemCacheReward(class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortRewardItemCacheData* K2Node_DynamicCast_AsFort_Reward_Item_Cache_Data, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::FrontEndRewards_Widget_C_PopulateItemCacheReward Parms{};
...
void UFrontEndRewards_Widget_C::HandleOnGiftBoxRemoved(bool bSucceeded, TDelegate<void(bool bSuccess)> K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UFrontEndRewards_Widget_C::ShowGiftBox(TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class UFortGiftBoxItemDefinition* CallFunc_GetGiftBoxDefinition_ReturnValue, class UClass* CallFunc_TryLoadPreMessageWidgetClass_OutWidgetClass, bool CallFunc_TryLoadPreMessageWidgetClass_ReturnValue, bool CallFunc_HasPreMessageWidget_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UItemReceived_Base_C* CallFunc_Create_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue_1, class UUserWidget* CallFunc_Create_ReturnValue_1, class UItemReceived_PrePrompt_C* K2Node_DynamicCast_AsItem_Received_Pre_Prompt, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::FrontEndRewards_Widget_C_ShowGiftBox Parms{};
...
void UFrontEndRewards_Widget_C::PopulateGiftBox(class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortGiftBoxItem* CallFunc_GetNextGiftBox_ReturnValue, TDelegate<void(bool bSuccess)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::FrontEndRewards_Widget_C_PopulateGiftBox Parms{};
...
// Parameters:
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
// TDelegate<void(bool Succeeded, TArray<struct FFortItemInstanceQuantityPair>& Rewards)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
// int32                                   CallFunc_Array_Length_ReturnValue                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void(int32 Index, class UFortItem* Item)>K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate_3                 (ZeroConstructor, NoDestructor)
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& ClaimedRewards)>K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
// int32                                   Temp_int_Loop_Counter_Variable                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Temp_int_Array_Index_Variable                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    CallFunc_Less_IntInt_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)>K2Node_CreateDelegate_OutputDelegate_6                 (ZeroConstructor, NoDestructor)
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate_7                 (ZeroConstructor, NoDestructor)
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)>K2Node_CreateDelegate_OutputDelegate_8                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)>K2Node_CreateDelegate_OutputDelegate_12                (ZeroConstructor, NoDestructor)
// class UFortQuestManager*                CallFunc_GetQuestManager_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate_13                (ZeroConstructor, NoDestructor)
// TDelegate<void(const struct FFortCollectionBookRewards& RewardClaimed, bool bSuccess, TArray<struct FFortItemInstanceQuantityPair>& ActualRewards)>K2Node_CreateDelegate_OutputDelegate_14                (ZeroConstructor, NoDestructor)
// class UFortGlobalUIContext*             CallFunc_GetContext_ReturnValue_1                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void(class UFortQuestItem* Quest, TArray<struct FFortItemInstanceQuantityPair>& Rewards)>K2Node_CreateDelegate_OutputDelegate_15                (ZeroConstructor, NoDestructor)
...
void UFrontEndRewards_Widget_C::TransitionIn(class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue)
{
	...
	Params::FrontEndRewards_Widget_C_TransitionIn Parms{};
...
// int32                                   Temp_int_Array_Index_Variable                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortItem*                        CallFunc_Array_Get_Item                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EFortInventoryType                      CallFunc_Array_Get_Item_1                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    CallFunc_EqualEqual_ByteByte_ReturnValue               (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UFrontEndRewards_Widget_C::HandleChoiceRewardSelected(int32 RewardIndex, class UFortItem* Item, class UFortRewardNotificationData* NotificationData, class UFortRewardQuestData* K2Node_DynamicCast_AsFort_Reward_Quest_Data, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, class UFortQuestItemDefinition* CallFunc_GetQuestDefinitionBP_ReturnValue, EFortQuestRewardType CallFunc_GetRewardType_ReturnValue, class UFortQuestItemDefinition* CallFunc_GetQuestDefinitionBP_ReturnValue_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, TArray<struct FFortItemQuantityPair>& CallFunc_GetRewards_BP_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, const class FString& CallFunc_GetPersistentName_ReturnValue, bool CallFunc_Contains_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	...
	Parms.CallFunc_GetQuestDefinitionBP_ReturnValue_1 = CallFunc_GetQuestDefinitionBP_ReturnValue_1;
	Parms.CallFunc_EqualEqual_ByteByte_ReturnValue = CallFunc_EqualEqual_ByteByte_ReturnValue;
	Parms.CallFunc_GetRewards_BP_ReturnValue = std::move(CallFunc_GetRewards_BP_ReturnValue);
	...
	CallFunc_GetRewards_BP_ReturnValue = std::move(Parms.CallFunc_GetRewards_BP_ReturnValue);
}
...
// Parameters:
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& ClaimedRewards)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
// int32                                   Temp_int_Loop_Counter_Variable                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Temp_int_Array_Index_Variable                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   CallFunc_Add_IntInt_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)>K2Node_CreateDelegate_OutputDelegate_3                 (ZeroConstructor, NoDestructor)
// TDelegate<void()>                       K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
// TDelegate<void(TArray<struct FFortItemInstanceQuantityPair>& MissionRewards)>K2Node_CreateDelegate_OutputDelegate_5                 (ZeroConstructor, NoDestructor)
...
void UFrontEndRewards_Widget_C::HandleCurrentRewardDisplayed(class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue)
{
	...
	Params::FrontEndRewards_Widget_C_HandleCurrentRewardDisplayed Parms{};
