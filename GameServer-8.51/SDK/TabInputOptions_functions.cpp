...
// TDelegate<void(int32 Number_in_List, bool Is_Primary_Button)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(int32 Number_in_List, class UOptionsMenuInput_C* Widget)>K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
...
void UTabInputOptions_C::ExecuteUbergraph_TabInputOptions(int32 EntryPoint, class FName Temp_name_Variable, bool CallFunc_Not_PreBool_ReturnValue, EFortDialogResult Temp_byte_Variable, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UOptionsMenuInputDisplayOnly_C* CallFunc_Create_ReturnValue, class UUserWidget* K2Node_ComponentBoundEvent_Widget, class UObject* CallFunc_GetItemAt_ReturnValue, class UOptionsMenuInput_C* K2Node_DynamicCast_AsOptions_Menu_Input, bool K2Node_DynamicCast_bSuccess, class UWidget* CallFunc_GetListWidget_ReturnValue, class UOptionsMenuInput_C* K2Node_DynamicCast_AsOptions_Menu_Input_1, bool K2Node_DynamicCast_bSuccess_1, ECommonInputType K2Node_Event_NewInputType, class FText CallFunc_MakeLiteralText_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, bool CallFunc_Not_PreBool_ReturnValue_1, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_Not_PreBool_ReturnValue_2, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue, ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_2, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, TDelegate<void(int32 Number_in_List, bool Is_Primary_Button)> K2Node_CreateDelegate_OutputDelegate_1, int32 K2Node_CustomEvent_Number_in_List_1, class UOptionsMenuInput_C* K2Node_CustomEvent_Widget, const struct FKey& K2Node_MakeStruct_Key, TDelegate<void(int32 Number_in_List, class UOptionsMenuInput_C* Widget)> K2Node_CreateDelegate_OutputDelegate_2, ESlateVisibility Temp_byte_Variable_1, int32 K2Node_CustomEvent_Number_in_List, bool K2Node_CustomEvent_Is_Primary_Button, ESlateVisibility Temp_byte_Variable_2, bool Temp_bool_Variable, const struct FKey& K2Node_CustomEvent_NewKey, ESlateVisibility Temp_byte_Variable_3, const struct FFortActionBeingUnbound& CallFunc_GetActionBeingUnbound_ReturnValue, ESlateVisibility K2Node_Select_Default, class UOptionsMenuInputDisplayOnly_C* CallFunc_SetupDisplayOption_ReturnObject, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, bool CallFunc_NotEqual_NameName_ReturnValue, bool CallFunc_IsValid_ReturnValue, ESlateVisibility Temp_byte_Variable_4, bool Temp_bool_Variable_1, ESlateVisibility K2Node_Select_Default_1)
{
	...
	Parms.CallFunc_GetActionBeingUnbound_ReturnValue = std::move(CallFunc_GetActionBeingUnbound_ReturnValue);
