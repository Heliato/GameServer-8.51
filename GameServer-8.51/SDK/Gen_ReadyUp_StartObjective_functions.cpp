...
void UGen_ReadyUp_StartObjective_C::BreakParams(float* Param_ReadyUpTimerLength, TArray<struct FTransform>* Param_InteractSpawnLocation, class FText* Param_InteractText, int32* Param_BluGloMissionActivationQty, bool* Param_IsFightTheStorm)
{
	...
	if (Param_InteractText != nullptr)
		*Param_InteractText = Parms.Param_InteractText;
...
void UGen_ReadyUp_StartObjective_C::SetParams(float Param_ReadyUpTimerLength, TArray<struct FTransform>& Param_InteractSpawnLocation, class FText Param_InteractText, int32 Param_BluGloMissionActivationQty, bool Param_IsFightTheStorm, class UGen_ReadyUp_StartObjective_C** ThisObject)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_InteractText = Param_InteractText;
