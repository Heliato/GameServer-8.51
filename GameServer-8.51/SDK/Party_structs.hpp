...
{
public:
	uint8                                         Pad_C43[0x18];                                     // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_C44[0x8];                                      // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUserPlatform                          Platform;                                          // 0x0020(0x0010)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_C45[0x30];                                     // 0x0030(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUniqueNetIdRepl                       PlatformUniqueId;                                  // 0x0060(0x0028)(HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C46[0x30];                                     // 0x0088(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 PlatformSessionId;                                 // 0x00B8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C47[0x30];                                     // 0x00C8(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_C48[0x37];                                     // 0x00F9(0x0037)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_C49[0x8];                                      // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0020(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_C4A[0x35];                                     // 0x0023(0x0035)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_C4B[0x18];                                     // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_C4C[0x10];                                     // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USocialChatChannel*>             ListenChannels;                                    // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_C4D[0x18];                                     // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
