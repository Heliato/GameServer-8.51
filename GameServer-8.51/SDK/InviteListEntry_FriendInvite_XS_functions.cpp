...
void UInviteListEntry_FriendInvite_XS_C::HandleOnlineIndicatorView(EOnlineStatus OnlineStatus, EOnlineStatus Temp_byte_Variable, const struct FLinearColor& K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
