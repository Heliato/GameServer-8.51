...
public:
	...
	uint8                                         Pad_2C35[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2C36[0x98];                                    // 0x0028(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C37[0x80];                                    // 0x00D0(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0150(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C38[0x50];                                    // 0x0160(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C39[0x5];                                     // 0x004B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
