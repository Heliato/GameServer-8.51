...
void UOptionsMenuRowSelector_C::Initialize_Row_Selector(class FText Row_Text, TArray<class FText>& Buttons, TArray<class FText>& Param_Hover_Texts, bool Require_Selection, class UCommonTextBlock* Tab_Tooltip)
{
	static class UFunction* Func = nullptr;
