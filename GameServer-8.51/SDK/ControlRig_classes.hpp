...
{
public:
	uint8                                         Pad_E1E[0x14];                                     // 0x0028(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E1F[0x3];                                      // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E20[0x40];                                     // 0x0110(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetGlobalTransform(class FName JointName, struct FTransform& InTransform);

	float GetDeltaTime() const;
	struct FTransform GetGlobalTransform(class FName JointName) const;
...
public:
	...
	uint8                                         Pad_E23[0x4];                                      // 0x04EC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E24[0x7];                                      // 0x0281(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E25[0x8];                                      // 0x0298(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E26[0x6];                                      // 0x0152(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
