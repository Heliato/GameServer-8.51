...
void UOptionsMenu_C::CreateMobileBackButton(bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, bool CallFunc_IsMobileGame_ReturnValue, ESlateVisibility K2Node_Select_Default)
{
	...
	Params::OptionsMenu_C_CreateMobileBackButton Parms{};
...
void UOptionsMenu_C::HandleResetAvailableActionHandlerStates(bool Temp_bool_Variable, EInputActionState Temp_byte_Variable, EInputActionState Temp_byte_Variable_1, EInputActionState K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Params::OptionsMenu_C_HandleResetAvailableActionHandlerStates Parms{};
...
void UOptionsMenu_C::UpdateAllOptionsTabs(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UFortOptionsTab* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Params::OptionsMenu_C_UpdateAllOptionsTabs Parms{};
...
void UOptionsMenu_C::ResetActionHandlerStates(bool DisableBack, bool Temp_bool_Variable, EInputActionState Temp_byte_Variable, EInputActionState Temp_byte_Variable_1, EInputActionState K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenu_C::HandleTabGamepadConfigActionHandlerStates(bool Temp_bool_Variable, EInputActionState Temp_byte_Variable, EInputActionState Temp_byte_Variable_1, int32 CallFunc_GetActiveWidgetIndex_ReturnValue, EInputActionState K2Node_Select_Default, class UWidget* CallFunc_GetWidgetAtIndex_ReturnValue, class UTabGamePadConfig_v3_C* K2Node_DynamicCast_AsTab_Game_Pad_Config_V_3, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::OptionsMenu_C_HandleTabGamepadConfigActionHandlerStates Parms{};
...
void UOptionsMenu_C::HandleResetUnavailableActionHandlerStates(bool ShouldShowApply, bool Temp_bool_Variable, EInputActionState Temp_byte_Variable, EInputActionState Temp_byte_Variable_1, bool CallFunc_BooleanAND_ReturnValue, EInputActionState K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenu_C::HandleTabGameOptionsActionHandlerStates(int32 Active_Widget_Index, bool Temp_bool_Variable, bool CallFunc_EqualEqual_IntInt_ReturnValue, EInputActionState Temp_byte_Variable, EInputActionState Temp_byte_Variable_1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, EInputActionState K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenu_C::SetBackground(bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenu_C::Set_Input_Action_Handlers(TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate_1, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate_2, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate_3, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate_4)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenu_C::Initialize(const struct FSlateBrush& Game_Normal, const struct FSlateBrush& Accounts_Normal, const struct FSlateBrush& Keys_Normal, const struct FSlateBrush& Controller_Normal, const struct FSlateBrush& Color_Normal, const struct FSlateBrush& Brightness_Normal, const struct FSlateBrush& Audio_Normal, const struct FSlateBrush& Video_Normal, class FText Temp_text_Variable, class FText Temp_text_Variable_1, class FName CallFunc_GetTabIdAtIndex_ReturnValue, class FText Temp_text_Variable_2, bool CallFunc_ShowBrightnessOptions_ReturnValue, bool Temp_bool_Variable, bool CallFunc_ShowAccessibilityOptions_ReturnValue, class UWidget* CallFunc_GetActiveWidget_ReturnValue, bool CallFunc_ShowAccountOptions_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UProgressModalWidget_C* CallFunc_Create_ReturnValue, bool CallFunc_ShowControllerOptions_ReturnValue, const class FString& CallFunc_GetPlatformName_ReturnValue, bool CallFunc_EqualEqual_StrStr_ReturnValue, bool CallFunc_HasWidgets_ReturnValue, class FText K2Node_Select_Default, class UWidget* CallFunc_GetWidgetAtIndex_ReturnValue, class UFortOptionsTab* K2Node_DynamicCast_AsFort_Options_Tab, bool K2Node_DynamicCast_bSuccess, bool CallFunc_ShowInputOptions_ReturnValue, class FText Temp_text_Variable_3, bool CallFunc_ShowVideoOptions_ReturnValue)
{
	...
	Parms.Game_Normal = std::move(Game_Normal);
	Parms.Accounts_Normal = std::move(Accounts_Normal);
	Parms.Keys_Normal = std::move(Keys_Normal);
	Parms.Controller_Normal = std::move(Controller_Normal);
	Parms.Color_Normal = std::move(Color_Normal);
	Parms.Brightness_Normal = std::move(Brightness_Normal);
	Parms.Audio_Normal = std::move(Audio_Normal);
	Parms.Video_Normal = std::move(Video_Normal);
...
// TDelegate<void(bool Accept_Input)>      K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
...
// TDelegate<void(EFortDialogResult Result, class FName ResultName)>K2Node_CreateDelegate_OutputDelegate_3                 (ZeroConstructor, NoDestructor)
...
// EFortDialogResult                       K2Node_CustomEvent_Result_5                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                                    K2Node_DynamicCast_bSuccess                            (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(EFortDialogResult Result, class FName ResultName)>K2Node_CreateDelegate_OutputDelegate_6                 (ZeroConstructor, NoDestructor)
...
// bool                                    CallFunc_ShowAccountOptions_ReturnValue                (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    CallFunc_ShowControllerOptions_ReturnValue             (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(bool Accept_Input, class FText Overlay_Text)>K2Node_CreateDelegate_OutputDelegate_7                 (ZeroConstructor, NoDestructor)
// bool                                    CallFunc_ShowInputOptions_ReturnValue                  (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_8                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_9                 (ZeroConstructor, NoDestructor)
// bool                                    CallFunc_ShowBrightnessOptions_ReturnValue             (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_10                (ZeroConstructor, NoDestructor)
...
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_11                (ZeroConstructor, NoDestructor)
...
// EInputActionState                       Temp_byte_Variable_6                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EInputActionState                       Temp_byte_Variable_7                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_15                (ZeroConstructor, NoDestructor)
// bool                                    CallFunc_Handle_Apply_PassThrough_1                    (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(TArray<class FText>& ScreenLabels)>K2Node_CreateDelegate_OutputDelegate_16                (ZeroConstructor, NoDestructor)
...
// bool                                    CallFunc_Less_IntInt_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(TSubclassOf<class UObject> Loaded)>K2Node_CreateDelegate_OutputDelegate_17                (ZeroConstructor, NoDestructor)
...
// TDelegate<void(class UWidget* ActiveWidget, int32 ActiveWidgetIndex)>K2Node_CreateDelegate_OutputDelegate_18                (ZeroConstructor, NoDestructor)
...
// bool                                    CallFunc_IsInZone_ReturnValue                          (ZeroConstructor, IsPlainOldData, NoDestructor)
// TDelegate<void(bool Gamepad_Enabled)>   K2Node_CreateDelegate_OutputDelegate_19                (ZeroConstructor, NoDestructor)
...
void UOptionsMenu_C::ExecuteUbergraph_OptionsMenu(int32 EntryPoint, class FName Temp_name_Variable, TDelegate<void(bool Accept_Input)> K2Node_CreateDelegate_OutputDelegate, EFortDialogResult Temp_byte_Variable, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, EFortDialogResult K2Node_CustomEvent_Result_4, class FName K2Node_CustomEvent_ResultName_4, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_1, class FName Temp_name_Variable_1, EFortDialogResult Temp_byte_Variable_1, bool CallFunc_EqualEqual_ByteByte_ReturnValue_2, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_1, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_2, EFortDialogResult K2Node_CustomEvent_Result_3, class FName K2Node_CustomEvent_ResultName_3, class FName Temp_name_Variable_2, EFortDialogResult Temp_byte_Variable_2, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_IsValid_ReturnValue_2, EFortDialogResult K2Node_CustomEvent_Result_2, class FName K2Node_CustomEvent_ResultName_2, class FName Temp_name_Variable_3, EFortDialogResult Temp_byte_Variable_3, bool CallFunc_EqualEqual_ByteByte_ReturnValue_3, class UInputPresetConfirmationRotator_C* CallFunc_Create_ReturnValue, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_4, EFortDialogResult K2Node_CustomEvent_Result_1, class FName K2Node_CustomEvent_ResultName_1, class FName Temp_name_Variable_4, EFortDialogResult Temp_byte_Variable_4, EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_5, class FName Temp_name_Variable_5, EFortDialogResult Temp_byte_Variable_5, bool K2Node_SwitchEnum_CmpSuccess, bool K2Node_CustomEvent_Accept_Input_1, class FText K2Node_CustomEvent_Overlay_Text, bool K2Node_CustomEvent_Accept_Input, EFortDialogResult K2Node_CustomEvent_Result_5, class FName K2Node_CustomEvent_ResultName_5, class FText CallFunc_MakeLiteralText_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_3, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, int32 CallFunc_GetActiveWidgetIndex_ReturnValue, class UWidget* CallFunc_GetWidgetAtIndex_ReturnValue, class UFortVideoOptions* K2Node_DynamicCast_AsFort_Video_Options, bool K2Node_DynamicCast_bSuccess, TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate_6, bool K2Node_CustomEvent_Gamepad_Enabled, class FName CallFunc_GetActiveTab_ReturnValue, class FName K2Node_ComponentBoundEvent_TabId_1, class UCommonButton* K2Node_ComponentBoundEvent_TabButton, bool CallFunc_EqualEqual_NameName_ReturnValue, class UIconTabButton_C* K2Node_DynamicCast_AsIcon_Tab_Button, bool K2Node_DynamicCast_bSuccess_1, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, bool CallFunc_IsVisible_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Handle_Reset_PassThrough, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UClass* Temp_class_Variable, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab, bool K2Node_ClassDynamicCast_bSuccess, class UClass* K2Node_CustomEvent_Loaded, int32 Temp_int_Variable, class UWidget* CallFunc_GetChildAt_ReturnValue, class UFortOptionsTab* K2Node_DynamicCast_AsFort_Options_Tab, bool K2Node_DynamicCast_bSuccess_2, int32 CallFunc_Add_IntInt_ReturnValue, class UTabGamePadConfig_v3_C* K2Node_DynamicCast_AsTab_Game_Pad_Config_V_3, bool K2Node_DynamicCast_bSuccess_3, class UTabGameOptions_C* K2Node_DynamicCast_AsTab_Game_Options, bool K2Node_DynamicCast_bSuccess_4, class UTabVideoOptions_C* K2Node_DynamicCast_AsTab_Video_Options, bool K2Node_DynamicCast_bSuccess_5, class UTabInputOptions_C* K2Node_DynamicCast_AsTab_Input_Options, bool K2Node_DynamicCast_bSuccess_6, class UWidget* K2Node_ComponentBoundEvent_ActiveWidget, int32 K2Node_ComponentBoundEvent_ActiveWidgetIndex, int32 CallFunc_GetChildrenCount_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, class UClass* Temp_class_Variable_1, int32 Temp_int_Array_Index_Variable, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab_1, bool K2Node_ClassDynamicCast_bSuccess_1, int32 CallFunc_Add_IntInt_ReturnValue_1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, class UWidget* K2Node_CustomEvent_ActiveWidget, int32 K2Node_CustomEvent_ActiveWidgetIndex, class UClass* K2Node_CustomEvent_Loaded_1, bool CallFunc_ShowVideoOptions_ReturnValue, bool CallFunc_ShowAccountOptions_ReturnValue, bool CallFunc_ShowControllerOptions_ReturnValue, TDelegate<void(bool Accept_Input, class FText Overlay_Text)> K2Node_CreateDelegate_OutputDelegate_7, bool CallFunc_ShowInputOptions_ReturnValue, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_8, class UClass* Temp_class_Variable_2, class UClass* K2Node_CustomEvent_Loaded_2, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab_2, bool K2Node_ClassDynamicCast_bSuccess_2, class UClass* Temp_class_Variable_3, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab_3, bool K2Node_ClassDynamicCast_bSuccess_3, bool CallFunc_IsVisible_ReturnValue_1, class UWidget* CallFunc_GetActiveWidget_ReturnValue, class UClass* K2Node_CustomEvent_Loaded_3, bool CallFunc_ShowAccessibilityOptions_ReturnValue, class UClass* Temp_class_Variable_4, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab_4, bool K2Node_ClassDynamicCast_bSuccess_4, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_9, bool CallFunc_ShowBrightnessOptions_ReturnValue, class FName K2Node_ComponentBoundEvent_TabId, bool CallFunc_Handle_Apply_PassThrough, class UClass* K2Node_CustomEvent_Loaded_4, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_10, class UWidget* CallFunc_GetActiveWidget_ReturnValue_1, class UClass* Temp_class_Variable_5, class UClass* K2Node_ClassDynamicCast_AsFort_Options_Tab_5, bool K2Node_ClassDynamicCast_bSuccess_5, class UFortOptionsTab* K2Node_DynamicCast_AsFort_Options_Tab_1, bool K2Node_DynamicCast_bSuccess_7, class UTabGameOptions_C* K2Node_DynamicCast_AsTab_Game_Options_1, bool K2Node_DynamicCast_bSuccess_8, int32 CallFunc_GetActiveWidgetIndex_ReturnValue_1, class UWidget* CallFunc_GetActiveWidget_ReturnValue_2, class UWidget* CallFunc_GetWidgetAtIndex_ReturnValue_1, class UTabGameOptionsHud_C* K2Node_DynamicCast_AsTab_Game_Options_Hud, bool K2Node_DynamicCast_bSuccess_9, class UTabGameOptionsMain_C* K2Node_DynamicCast_AsTab_Game_Options_Main, bool K2Node_DynamicCast_bSuccess_10, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_11, class UWidget* CallFunc_GetActiveWidget_ReturnValue_3, class UTabInputOptions_C* K2Node_DynamicCast_AsTab_Input_Options_1, bool K2Node_DynamicCast_bSuccess_11, class UClass* K2Node_CustomEvent_Loaded_5, EInputActionState Temp_byte_Variable_6, EInputActionState Temp_byte_Variable_7, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_12, bool Temp_bool_Variable, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_13, EInputActionState K2Node_Select_Default, int32 Temp_int_Loop_Counter_Variable, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_14, int32 CallFunc_Add_IntInt_ReturnValue_2, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_15, bool CallFunc_Handle_Apply_PassThrough_1, TDelegate<void(TArray<class FText>& ScreenLabels)> K2Node_CreateDelegate_OutputDelegate_16, TArray<class FText>& K2Node_CustomEvent_ScreenLabels, class FText CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData_1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData_2, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array_1, class FText CallFunc_Format_ReturnValue, class FText CallFunc_Format_ReturnValue_1, int32 CallFunc_Subtract_IntInt_ReturnValue, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue_1, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_4, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_5, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue, TDelegate<void(TSubclassOf<class UObject> Loaded)> K2Node_CreateDelegate_OutputDelegate_17, bool CallFunc_HandleBack_PassThrough, int32 CallFunc_GetActiveWidgetIndex_ReturnValue_2, TDelegate<void(class UWidget* ActiveWidget, int32 ActiveWidgetIndex)> K2Node_CreateDelegate_OutputDelegate_18, class UWidget* CallFunc_GetWidgetAtIndex_ReturnValue_2, class UTabGamePadConfig_v3_C* K2Node_DynamicCast_AsTab_Game_Pad_Config_V_3_1, bool K2Node_DynamicCast_bSuccess_12, class UFortHUDContext* CallFunc_GetContext_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_1, bool CallFunc_IsInZone_ReturnValue, TDelegate<void(bool Gamepad_Enabled)> K2Node_CreateDelegate_OutputDelegate_19, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_20, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_2, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_21, bool CallFunc_HandleBack_PassThrough_1, class UCommonButton* K2Node_ComponentBoundEvent_Button, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_22)
{
	static class UFunction* Func = nullptr;
