...
public:
	...
	void ExecuteUbergraph_MainTabTutorialWrapper(int32 EntryPoint, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, class FName K2Node_Event_TutorialObjectiveName, ETutorialType K2Node_Event_TutorialType);
