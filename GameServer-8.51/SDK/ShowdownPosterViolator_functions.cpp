...
// EEventTimeState                         K2Node_Event_NewTimeState                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EEventTimeState                         Temp_byte_Variable                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UShowdownPosterViolator_C::ExecuteUbergraph_ShowdownPosterViolator(int32 EntryPoint, EEventTimeState K2Node_Event_NewTimeState, EEventTimeState Temp_byte_Variable, class UCommonBorder* K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
