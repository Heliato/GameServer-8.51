...
public:
	...
	UMulticastInlineDelegateProperty_             OnRequestRetry;                                    // 0x0370(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
