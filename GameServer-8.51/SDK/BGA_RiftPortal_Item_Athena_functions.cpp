...
// TDelegate<void(class AFortPlayerPawnAthena* FortPlayerPawnAthena)>K2Node_CreateDelegate_OutputDelegate                   (ZeroConstructor, NoDestructor)
// struct FVector                          CallFunc_Add_VectorVector_ReturnValue                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TDelegate<void(class FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor)
...
void ABGA_RiftPortal_Item_Athena_C::EjectFromTurret(class AFortPlayerPawn* Param_PlayerPawn, class AFortAthenaVehicle* CallFunc_GetVehicle_ReturnValue, class UAbilitySystemComponent* CallFunc_GetAbilitySystemComponent_ReturnValue, bool CallFunc_CanTeleport_ReturnValue, int32 CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue, bool CallFunc_IsInVehicle_ReturnValue)
{
	static class UFunction* Func = nullptr;
