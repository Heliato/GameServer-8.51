...
// TDelegate<void(class APawn* PossessedPawn)>K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(class UAthenaMusicPackItemDefinition* NewMusicPack)>K2Node_CreateDelegate_OutputDelegate_4                 (ZeroConstructor, NoDestructor)
...
// TDelegate<void(bool bIsGhosting)>       K2Node_CreateDelegate_OutputDelegate_6                 (ZeroConstructor, NoDestructor)
...
void AAthena_PlayerController_C::SetupPermissionRecheckTimer(TDelegate<void()> K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::Athena_PlayerController_C_SetupPermissionRecheckTimer Parms{};
