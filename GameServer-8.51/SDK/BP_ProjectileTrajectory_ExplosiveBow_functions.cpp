...
void ABP_ProjectileTrajectory_ExplosiveBow_C::UpdateFromTrajectoryOwner(TScriptInterface<class IFortTrajectoryAbilityInterface> K2Node_DynamicCast_AsFort_Trajectory_Ability_Interface, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::BP_ProjectileTrajectory_ExplosiveBow_C_UpdateFromTrajectoryOwner Parms{};
...
void ABP_ProjectileTrajectory_ExplosiveBow_C::SetShouldUpdateFromOwner(bool ShouldUpdate, class UObject* Param_Owner, float Interval, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue)
{
	static class UFunction* Func = nullptr;
