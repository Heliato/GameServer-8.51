...
void UTopBar_C::SetButtonStyleForMobile(bool CallFunc_IsUsingTouch_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	Params::TopBar_C_SetButtonStyleForMobile Parms{};
...
void UTopBar_C::UninitializeInput(const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, class UFortGlobalUIContext* CallFunc_GetLocalPlayerSubsystem_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue)
{
	...
	Params::TopBar_C_UninitializeInput Parms{};
...
void UTopBar_C::InitializeInput(const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, class UFortGlobalUIContext* CallFunc_GetLocalPlayerSubsystem_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
	...
	Params::TopBar_C_InitializeInput Parms{};
...
void UTopBar_C::OnCloseRequested(bool CallFunc_HandleCloseAction_PassThrough)
{
	...
	Params::TopBar_C_OnCloseRequested Parms{};
...
void UTopBar_C::CloseMainMenu(const struct FMargin& K2Node_MakeStruct_Margin, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue)
{
	static class UFunction* Func = nullptr;
