...
void UGCN_MedicPack_Equipped_C::GetFuelPercent(class APlayerPawn_Athena_C* PlayerPawn, float* Fuel_Percent, float CallFunc_GetFuel_ReturnValue, float CallFunc_GetMaxFuel_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue) const
{
	static class UFunction* Func = nullptr;
