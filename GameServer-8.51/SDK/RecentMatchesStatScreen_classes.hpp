...
public:
	...
	void ExecuteUbergraph_RecentMatchesStatScreen(int32 EntryPoint, TArray<class UAthenaMatchStatView*>& CallFunc_GetRecentMatches_ReturnValue, TDelegate<void(bool* bPassThrough)> K2Node_CreateDelegate_OutputDelegate);
